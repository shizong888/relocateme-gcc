...
function HeroGeometric({
    title1 = "Middle East Global Mobility & Corporate Services",
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white">
            ...
            >
                <source src="/relocateme-hero-video.mp4" type="video/mp4" />
            </video>
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <motion.div
                        ...
                        animate="visible"
                    >
                        <h1 className="text-3xl sm:text-5xl md:text-6xl font-light mb-6 md:mb-8 tracking-tight">
