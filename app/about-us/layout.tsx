...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `/api/og?image=${encodeURIComponent('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&q=80')}`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`/api/og?image=${encodeURIComponent('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&q=80')}`]
  },
  alternates: {
