...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `/api/og?image=${encodeURIComponent('https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1200&q=80')}`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`/api/og?image=${encodeURIComponent('https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1200&q=80')}`]
  },
  alternates: {
