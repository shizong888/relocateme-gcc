      ...
      <section className="pt-20 bg-white">
        <div className="container mx-auto px-4 md:px-6 mb-16">
          <SectionHeader
            ...
            buttonText="Book a Corporate Consultation"
        ...
        <div className="container mx-auto px-4 md:px-6 pt-20 pb-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-light leading-tight text-left">
              Your <span className="text-[hsl(var(--brand))]">Corporate Visa Journey in Saudi Arabia</span>
            </h2>
            <p className="text-lg text-gray-600 mt-4">
              Achieve seamless workforce onboarding with RelocateMe's structured, compliance-first process.
            </p>
          </motion.div>
        </div>
